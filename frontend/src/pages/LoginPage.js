...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-white to-orange-50 flex items-center justify-center p-4" data-testid="login-page">
      {/* Language Switcher */}
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex justify-end">
              <Link to="/forgot-password" className="text-sm text-red-500 hover:text-red-600 hover:underline">
                {t('forgotPassword')}
              </Link>
            </div>
          ...
          <div className="mt-6 text-center text-sm">
            ...
            <Link to="/register" className="text-red-500 hover:text-red-600 font-medium hover:underline" data-testid="register-link">
              {t('signUp')}
            </Link>
          </div>
